...
편집기는 이러한 입력에 아직 값이 할당되지 않았기 때문에 x 및 y의 타입을 알지 못하므로 실행 오류를 표시합니다:

![Figure_42](https://github.com/user-attachments/assets/b38f7545-174a-4238-8f8a-2d469bec43fd)

각 입력을 마우스 오른쪽 버튼으로 클릭하고 타입 힌트 하위 메뉴에서 부동 소수점 옵션을 선택합니다. 이렇게 하면 입력이 선택한 타입에 대한 기본값으로 초기화됩니다:
